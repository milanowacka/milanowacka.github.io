#!/usr/bin/env python3
"""Generates the site's HTML pages from content/page-content.md.

The logic lives here (rather than directly in update_content.py) so it can be
imported both by the CI script and by the desktop content-manager app for
offline preview.
"""
import re
...
def generate_site(base_dir: Path = Path(".")) -> None:
