...
# License, Version 2.0.
#
# Vendored from dulwich/contrib/paramiko_vendor.py (jelmer/dulwich, current
# `main` as of 2026-08-29) because that module ships in dulwich's source tree
# but is excluded from the published PyPI wheel.
...
the dulwich.client.get_ssh_vendor attribute:
  ...
  >>> from _paramiko_vendor import ParamikoSSHVendor
